...
if ( is_ssl() ) {
	...
	$ssf_wp_siteurl = str_replace( 'http://', 'https://', $ssf_wp_siteurl );
}
...
$top_nav_base=$ssf_wp_siteurl."/wp-admin/admin.php?page="; 
...
if (isset($_SERVER['HTTP_HOST'])) {
	$web_domain=str_replace("www.","",$_SERVER['HTTP_HOST']);
		...
		define('SSF_WP_TRACKER_PAGE', SSF_WP_TOP_NAV_BASE.SSF_WP_PAGES_DIR."/tracker.php");
