...
$thumb_settings["".__("Cover", SSF_WP_TEXT_DOMAIN).""]="cover";
$thumb_settings["".__("Contain", SSF_WP_TEXT_DOMAIN).""]="contain";


$thumb_settings_options="";

foreach($thumb_settings as $key=>$value) {
	$selected2=($ssf_wp_vars['ssf_wp_map_settings']==$value)? " selected " : "";
	$thumb_settings_options.="<option value='$value' $selected2>$key</option>\n";
}
...
$set_show_mobile="";
foreach($labeled_marker_settings as $key=>$value) {
	$selected2=($ssf_wp_vars['show_all_mobile']==$value)? " selected " : "";
	$set_show_mobile.="<option value='$value' $selected2>$key</option>\n";
}
...
$pagination_settings["".__("3", SSF_WP_TEXT_DOMAIN).""]="3";
$pagination_settings["".__("6", SSF_WP_TEXT_DOMAIN).""]="6";
$pagination_settings["".__("9", SSF_WP_TEXT_DOMAIN).""]="9";
$pagination_settings["".__("12", SSF_WP_TEXT_DOMAIN).""]="12";
$pagination_settings["".__("15", SSF_WP_TEXT_DOMAIN).""]="15";
$pagination_settings["".__("27", SSF_WP_TEXT_DOMAIN).""]="27";
$pagination_settings["".__("30", SSF_WP_TEXT_DOMAIN).""]="30";
$pagination_settings["".__("54", SSF_WP_TEXT_DOMAIN).""]="54";
$pagination_settings["".__("60", SSF_WP_TEXT_DOMAIN).""]="60";
...
$cross_color="";
$cross_color_settings["".__("Light", SSF_WP_TEXT_DOMAIN).""]="light";
$cross_color_settings["".__("Dark", SSF_WP_TEXT_DOMAIN).""]="dark";

foreach($cross_color_settings as $key=>$value) {
	$selected3=($ssf_wp_vars['infowindowclosebutton']==$value)? " selected " : "";
	$cross_color.="<option value='$value' $selected3>$key</option>\n";
}
...
$ssf_wp_mdo[] = array("field_name" => "google_api_key", "default" => "", "input_zone" => "defaults", "label" => __("Google API Key", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='google_api_key' value=\"$ssf_wp_vars[google_api_key]\"><small>(Required <a href='http://superstorefinder.net/support/knowledgebase/google-maps-platform-will-require-api-key-pay-go-billing-starting-june-11-2018/' target='new'>more details</a>)</small>");

$ssf_wp_mdo[] = array("field_name" => "google_geo_key", "default" => "", "input_zone" => "defaults", "label" => __("Google Geocoding Key", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='google_geo_key' value=\"$ssf_wp_vars[google_geo_key]\"><small>(Required <a href='http://superstorefinder.net/support/knowledgebase/create-google-geocoding-key/' target='new'>more details</a>)</small>");

$ssf_wp_mdo[] = array("field_name" => "google_rc_key", "default" => "", "input_zone" => "defaults", "label" => __("Google Recaptcha Key", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='google_rc_key' value=\"$ssf_wp_vars[google_rc_key]\"><small>(Optional <a href='http://superstorefinder.net/support/knowledgebase/creating-recaptcha-key-for-reviews-ratings-add-on/' target='new'>more details</a>)</small>");
...
$ssf_wp_mdo[] = array("field_name" => "mobile_gesture", "default" => "true", "input_zone" => "defaults", "label" => __("Mobile Gesture
", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='mobile_gesture'>\n$mobile_gesture</select>");

$ssf_wp_mdo[] = array("field_name" => "thumb_settings_options", "default" => "true", "input_zone" => "defaults", "label" => __("Thumbnail Setting
", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='thumb_settings_options'>\n$thumb_settings_options</select> <small>(<a href='https://superstorefinder.net/support/knowledgebase/how-to-show-full-image-store-thumbnails/' target='new'>more info</a>)</small>");
...
$ssf_wp_mdo[] = array("field_name" => "marker_label_color", "default" => "", "input_zone" => "defaults", "output_zone" => "ssf_wp_dyn_js", "label" => __("Marker Letter Color", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='marker_label_color' value=\"$ssf_wp_vars[marker_label_color]\" class=\"ssf-color-field\" >");

$data_source="";
$datta_source_condition["".__("XML (Default)", SSF_WP_TEXT_DOMAIN).""]="false";
$datta_source_condition["".__("JSON", SSF_WP_TEXT_DOMAIN).""]="true";
foreach($datta_source_condition as $key=>$value) {
	$selected2=($ssf_wp_vars['data_source']==$value)? " selected " : "";
	$data_source.="<option value='$value' $selected2>$key</option>\n";
}
$ssf_wp_mdo[] = array("field_name" => "data_source", "default" => "false", "input_zone" => "defaults", "label" => __("Data Source
", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='data_source'>\n$data_source</select>");



$plugin_asset="";
$plugin_asset_condition["".__("Plugin page only (default)", SSF_WP_TEXT_DOMAIN).""]="false";
$plugin_asset_condition["".__("All pages", SSF_WP_TEXT_DOMAIN).""]="true";
foreach($plugin_asset_condition as $key=>$value) {
	$selected2=($ssf_wp_vars['plugin_asset']==$value)? " selected " : "";
	$plugin_asset.="<option value='$value' $selected2>$key</option>\n";
}
$ssf_wp_mdo[] = array("field_name" => "plugin_asset", "default" => "false", "input_zone" => "defaults", "label" => __("Load Plugin Asset", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='plugin_asset'>\n$plugin_asset</select>");
...
$ssf_gdpr="";
$gdpr_condition["".__("Yes", SSF_WP_TEXT_DOMAIN).""]="true";
$gdpr_condition["".__("No", SSF_WP_TEXT_DOMAIN).""]="false";
foreach($gdpr_condition as $key=>$value) {
	$selected2=($ssf_wp_vars['ssf_gdpr']==$value)? " selected " : "";
	$ssf_gdpr.="<option value='$value' $selected2>$key</option>\n";
}
$ssf_wp_mdo[] = array("field_name" => "ssf_gdpr", "default" => "false", "input_zone" => "defaults", "label" => __("GDPR
", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='ssf_gdpr'>\n$ssf_gdpr</select> <small>(<a href='http://superstorefinder.net/support/knowledgebase/gdpr-compliant-form-settings/' target='new'>more details</a>)</small>");

$ssf_wp_mdo[] = array("field_name" => "ssf_gdpr_link", "default" => "", "input_zone" => "defaults", "label" => __("GDPR Privacy Link", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_gdpr_link' value=\"$ssf_wp_vars[ssf_gdpr_link]\" size='14'>");


$ssf_anatrac="";
$anatrac_condition["".__("Enabled", SSF_WP_TEXT_DOMAIN).""]="true";
$anatrac_condition["".__("Disabled", SSF_WP_TEXT_DOMAIN).""]="false";
foreach($anatrac_condition as $key=>$value) {
	$selected2=($ssf_wp_vars['ssf_anatrac']==$value)? " selected " : "";
	$ssf_anatrac.="<option value='$value' $selected2>$key</option>\n";
}
$ssf_wp_mdo[] = array("field_name" => "ssf_anatrac", "default" => "true", "input_zone" => "defaults", "label" => __("Analytics Tracking
", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='ssf_anatrac'>\n$ssf_anatrac</select>");


$ssf_txticon="";
$txtico_condition["".__("No (Default)", SSF_WP_TEXT_DOMAIN).""]="false";
$txtico_condition["".__("Yes", SSF_WP_TEXT_DOMAIN).""]="true";
foreach($txtico_condition as $key=>$value) {
	$selected2=($ssf_wp_vars['ssf_text_icon']==$value)? " selected " : "";
	$ssf_txticon.="<option value='$value' $selected2>$key</option>\n";
}
$ssf_wp_mdo[] = array("field_name" => "ssf_text_icon", "default" => "false", "input_zone" => "defaults", "label" => __("Store info icons
", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='ssf_text_icon'>\n$ssf_txticon</select>");
// styles

$ssf_wp_mdo[] = array("field_name" => "style_map_color", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Map Hue Color", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_map_color' value=\"$ssf_wp_vars[style_map_color]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_map_bg", "default" =>"", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Main background color", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_map_bg' value=\"$ssf_wp_vars[style_map_bg]\" class=\"ssf-color-field\" >");
...
$ssf_wp_mdo[] = array("field_name" => "style_top_bar_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Top Bar Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_top_bar_bg' value=\"$ssf_wp_vars[style_top_bar_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_top_bar_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Top Bar Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_top_bar_font' value=\"$ssf_wp_vars[style_top_bar_font]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_geo_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Geo Icon", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_geo_font' value=\"$ssf_wp_vars[style_geo_font]\" class=\"ssf-color-field\" >");


$ssf_wp_mdo[] = array("field_name" => "style_top_bar_border", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Filter Border", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_top_bar_border' value=\"$ssf_wp_vars[style_top_bar_border]\" class=\"ssf-color-field\" >");


$ssf_wp_mdo[] = array("field_name" => "filter_font_color", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Filter Font Color", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='filter_font_color' value=\"$ssf_wp_vars[filter_font_color]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_results_distance_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Show All Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_results_distance_font' value=\"$ssf_wp_vars[style_results_distance_font]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_results_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Results Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_results_bg' value=\"$ssf_wp_vars[style_results_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_results_hl_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Results Highlighted Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_results_hl_bg' value=\"$ssf_wp_vars[style_results_hl_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_results_hover_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Results Hover Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_results_hover_bg' value=\"$ssf_wp_vars[style_results_hover_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_results_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Results Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_results_font' value=\"$ssf_wp_vars[style_results_font]\" class=\"ssf-color-field\" >");



$ssf_wp_mdo[] = array("field_name" => "style_distance_toggle_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Direction Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_distance_toggle_bg' value=\"$ssf_wp_vars[style_distance_toggle_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_contact_button_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Info Window Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_contact_button_bg' value=\"$ssf_wp_vars[style_contact_button_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_contact_button_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Info Window Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_contact_button_font' value=\"$ssf_wp_vars[style_contact_button_font]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_info_link_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Info Window Button Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_info_link_bg' value=\"$ssf_wp_vars[style_info_link_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_info_link_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Info Window Button Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_info_link_font' value=\"$ssf_wp_vars[style_info_link_font]\" class=\"ssf-color-field\" >");



$ssf_wp_mdo[] = array("field_name" => "info_window_buttons", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Info Window Street View/Direction", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='info_window_buttons' value=\"$ssf_wp_vars[info_window_buttons]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "infowindowlink", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Infowindow Link", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='infowindowlink' value=\"$ssf_wp_vars[infowindowlink]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "infowindowclosebutton", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Info Window Close Button", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='infowindowclosebutton'>\n$cross_color</select>");


$ssf_wp_mdo[] = array("field_name" => "style_button_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Buttons Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_button_bg' value=\"$ssf_wp_vars[style_button_bg]\" class=\"ssf-color-field\" >");



$ssf_wp_mdo[] = array("field_name" => "style_button_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Buttons Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_button_font' value=\"$ssf_wp_vars[style_button_font]\" class=\"ssf-color-field\" >");


$ssf_wp_mdo[] = array("field_name" => "previousnextbuttonbg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Previous / Next Button Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='previousnextbuttonbg' value=\"$ssf_wp_vars[previousnextbuttonbg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "previousnextbuttonclr", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Previous / Next Font Color", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='previousnextbuttonclr' value=\"$ssf_wp_vars[previousnextbuttonclr]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "storesnearyou", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Stores Near You Color", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='storesnearyou' value=\"$ssf_wp_vars[storesnearyou]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "notificationlinks", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Notification Links", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='notificationlinks' value=\"$ssf_wp_vars[notificationlinks]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_list_number_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Number List Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_list_number_bg' value=\"$ssf_wp_vars[style_list_number_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_list_number_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Number List Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_list_number_font' value=\"$ssf_wp_vars[style_list_number_font]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_list_number_circle", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Number List Circle", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_list_number_circle' value=\"$ssf_wp_vars[style_list_number_circle]\" class=\"ssf-color-field\" >");
...
$ssf_wp_mdo[] = array("field_name" => "style_list_number_bg_active", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Number List Background Active", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_list_number_bg_active' value=\"$ssf_wp_vars[style_list_number_bg_active]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_list_number_font_active", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Number List Font Active", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_list_number_font_active' value=\"$ssf_wp_vars[style_list_number_font_active]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_scroll_to_top_bg", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Scroll To Top Background", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_scroll_to_top_bg' value=\"$ssf_wp_vars[style_scroll_to_top_bg]\" class=\"ssf-color-field\" >");

$ssf_wp_mdo[] = array("field_name" => "style_scroll_to_top_font", "default" => "", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Scroll To Top Font", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='style_scroll_to_top_font' value=\"$ssf_wp_vars[style_scroll_to_top_font]\" class=\"ssf-color-field\" >");
...
$ssf_wp_mdo[] = array("field_name" => "by_country_label", "default" => "By Country", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("By Country", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='by_country_label' value=\"$ssf_wp_vars[by_country_label]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "all_country", "default" => "All Country", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("All Country", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='all_country' value=\"$ssf_wp_vars[all_country]\" size='14'>","stripslashes" => 1);
...
$ssf_wp_mdo[] = array("field_name" => "custom_field1_label", "default" => "Custom Field 1", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Field 1", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_custom_field1_label' value=\"".$ssf_wp_vars['custom_field1_label']."\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "custom_field2_label", "default" => "Custom Field 2", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Field 2", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_custom_field2_label' value=\"".$ssf_wp_vars['custom_field2_label']."\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "custom_field3_label", "default" => "Custom Field 3", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Field 3", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_custom_field3_label' value=\"".$ssf_wp_vars['custom_field3_label']."\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "custom_field4_label", "default" => "Custom Field 4", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Field 4", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_custom_field4_label' value=\"".$ssf_wp_vars['custom_field4_label']."\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "custom_field5_label", "default" => "Custom Field 5", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Field 5", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_custom_field5_label' value=\"".$ssf_wp_vars['custom_field5_label']."\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "custom_field6_label", "default" => "Custom Field 6", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Field 6", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_wp_custom_field6_label' value=\"".$ssf_wp_vars['custom_field6_label']."\" size='14'>","stripslashes" => 1);
...
foreach($state_label_settings as $key=>$value) {
	...
	$selected3=($ssf_wp_vars['email_label_show']==$value)? " selected " : "";
	$email_label_2.="<option value='$value' $selected3>$key</option>\n";
}
...
$ssf_wp_mdo[] = array("field_name" => "email_label_show", "default" => "true", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Email show", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='email_label_show'>$email_label_2</select>", "stripslashes" => 1);
...
$ssf_wp_mdo[] = array("field_name" => "YourSearchlocation", "default" => "Your search location", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Your search location", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='YourSearchlocation' value=\"$ssf_wp_vars[YourSearchlocation]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "YourCurrentlocation", "default" => "Your current location", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Your current location", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='YourCurrentlocation' value=\"$ssf_wp_vars[YourCurrentlocation]\" size='14'>","stripslashes" => 1);
...
$ssf_wp_mdo[] = array("field_name" => "show_all_mobile", "default" => "0", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Show All link Visible in Mobile", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='show_all_mobile'>\n$set_show_mobile</select>", "stripslashes" => 1);
...
$country_settings="";
$country_vals["".__("Disabled", SSF_WP_TEXT_DOMAIN).""]="no";
$country_vals["".__("Enabled", SSF_WP_TEXT_DOMAIN).""]="yes";
foreach($country_vals as $key=>$value) {
	$selected2=($ssf_wp_vars['country_set']==$value)? " selected " : "";
	$country_settings.="<option value='$value' $selected2>$key</option>\n";
}

$ssf_wp_mdo[] = array("field_name" => "country_set", "default" => "no", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Country Filter", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='country_set'>\n$country_settings</select>", "stripslashes" => 1);
...
$TagsiInfoWindow_settings="";
$TagsiInfoWindow["".__("No", SSF_WP_TEXT_DOMAIN).""]="no";
$TagsiInfoWindow["".__("Yes", SSF_WP_TEXT_DOMAIN).""]="yes";

foreach($TagsiInfoWindow as $key=>$value) {
	$selected2=($ssf_wp_vars['TagsinInfoWindow']==$value)? " selected " : "";
	$TagsiInfoWindow_settings.="<option value='$value' $selected2>$key</option>\n";
}

$ssf_wp_mdo[] = array("field_name" => "TagsinInfoWindow", "default" => "no", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Tags in Info Window", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='TagsinInfoWindow'>\n$TagsiInfoWindow_settings</select>", "stripslashes" => 1);

$TagsinResultList_settings="";
$TagsinResultList["".__("No", SSF_WP_TEXT_DOMAIN).""]="no";
$TagsinResultList["".__("Yes", SSF_WP_TEXT_DOMAIN).""]="yes";

foreach($TagsinResultList as $key=>$value) {
	$selected2=($ssf_wp_vars['TagsinResultList']==$value)? " selected " : "";
	$TagsinResultList_settings.="<option value='$value' $selected2>$key</option>\n";
}

$ssf_wp_mdo[] = array("field_name" => "TagsinResultList", "default" => "no", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Tags in Result List ", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='TagsinResultList'>\n$TagsinResultList_settings</select>", "stripslashes" => 1);
...
//GDPR Privacy Link - text box

$ssf_wp_mdo[] = array("field_name" => "ssf_gdpr_agnt", "default" => "GDPR Agreement", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("GDPR Agreement", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_gdpr_agnt' value=\"$ssf_wp_vars[ssf_gdpr_agnt]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_gdpr_pp", "default" => "Privacy Policy", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Privacy Policy", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_gdpr_pp' value=\"$ssf_wp_vars[ssf_gdpr_pp]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_gdpr_txt", "default" => "I have consent to use Google Maps and having this website store my submitted information so they can respond to my inquiry", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("GDPR Text", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_gdpr_txt' value=\"$ssf_wp_vars[ssf_gdpr_txt]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_gdpr_accept", "default" => "ACCEPT", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("GDPR Accept", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_gdpr_accept' value=\"$ssf_wp_vars[ssf_gdpr_accept]\" size='14'>","stripslashes" => 1);
...
$ssf_wp_mdo[] = array("field_name" => "Requestnewstore", "default" => "REQUEST NEW STORE", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Request New Store", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='Requestnewstore' value=\"$ssf_wp_vars[Requestnewstore]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_store", "default" => "Enter your store name", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Store name", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_store' value=\"$ssf_wp_vars[ssf_lbl_store]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_tags", "default" => "Enter categories / tags separated with commas", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter categories", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_tags' value=\"$ssf_wp_vars[ssf_lbl_tags]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_address", "default" => "Enter Address", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter Address", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_address' value=\"$ssf_wp_vars[ssf_lbl_address]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_city", "default" => "Enter City", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter City", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_city' value=\"$ssf_wp_vars[ssf_lbl_city]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_state", "default" => "Enter State", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter State", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_state' value=\"$ssf_wp_vars[ssf_lbl_state]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_zip", "default" => "Enter Zip Code", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter Zip Code", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_zip' value=\"$ssf_wp_vars[ssf_lbl_zip]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_phone", "default" => "Enter Phone number", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter Phone number", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_phone' value=\"$ssf_wp_vars[ssf_lbl_phone]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_fax", "default" => "Enter Fax number", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter Fax number", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_fax' value=\"$ssf_wp_vars[ssf_lbl_fax]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_email", "default" => "Enter Email Address", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter Email Address", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_email' value=\"$ssf_wp_vars[ssf_lbl_email]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_url", "default" => "Enter Website URL", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter Website URL", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_url' value=\"$ssf_wp_vars[ssf_lbl_url]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_ext_url", "default" => "Enter External URL", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Enter External URL", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_ext_url' value=\"$ssf_wp_vars[ssf_lbl_ext_url]\" size='14'>","stripslashes" => 1);

$contact_lb_label="";
$contact_label_settings["".__("None", SSF_WP_TEXT_DOMAIN).""]="0";
$contact_label_settings["".__("Store's Email", SSF_WP_TEXT_DOMAIN).""]="1";
$contact_label_settings["".__("Settings' Email", SSF_WP_TEXT_DOMAIN).""]="2";

foreach($contact_label_settings as $key=>$value) {
	$selected2=($ssf_wp_vars['ssf_lbl_contact_email']==$value)? " selected " : "";
	$contact_lb_label.="<option value='$value' $selected2>$key</option>\n";
}
$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_contact_email", "default" => "0", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Contact Us Email", SSF_WP_TEXT_DOMAIN), "input_template" => "<select name='ssf_lbl_contact_email'>$contact_lb_label</select>", "stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_description", "default" => "Description", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Description", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_description' value=\"$ssf_wp_vars[ssf_lbl_description]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_hours", "default" => "Opening Hours", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Opening Hours", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_hours' value=\"$ssf_wp_vars[ssf_lbl_hours]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_image", "default" => "Image", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Store Image", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_image' value=\"$ssf_wp_vars[ssf_lbl_image]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_video", "default" => "Video", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Store Video", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_video' value=\"$ssf_wp_vars[ssf_lbl_video]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_marker", "default" => "Custom Marker", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Custom Marker", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_marker' value=\"$ssf_wp_vars[ssf_lbl_marker]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_embed_video", "default" => "Embed Video", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Embed Video", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_embed_video' value=\"$ssf_wp_vars[ssf_lbl_embed_video]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_default_media", "default" => "Default Media", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Default Media", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_default_media' value=\"$ssf_wp_vars[ssf_lbl_default_media]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_default_image", "default" => "Image", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Image", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_default_image' value=\"$ssf_wp_vars[ssf_lbl_default_image]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_latitude", "default" => "Latitude", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Latitude", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_latitude' value=\"$ssf_wp_vars[ssf_lbl_latitude]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssf_lbl_longitude", "default" => "Longitude", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Longitude", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssf_lbl_longitude' value=\"$ssf_wp_vars[ssf_lbl_longitude]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssfRqstStoresScs", "default" => "Thank you for your submission.", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Thank you Message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssfRqstStoresScs' value=\"$ssf_wp_vars[ssfRqstStoresScs]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssfRqstStoresfail", "default" => "Sorry, we couldn't send your submission at this moment.", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Fail Submission Message", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssfRqstStoresfail' value=\"$ssf_wp_vars[ssfRqstStoresfail]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssfNotificationTitle", "default" => "Super Store Finder - New store has been added", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Notification email subject", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssfNotificationTitle' value=\"$ssf_wp_vars[ssfNotificationTitle]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssfNotificationBody", "default" => "A new store has been added, please login to administrator's area to approve the request", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Notification email body", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssfNotificationBody' value=\"$ssf_wp_vars[ssfNotificationBody]\" size='14'>","stripslashes" => 1);

$ssf_wp_mdo[] = array("field_name" => "ssfAddStores", "default" => "Submit Store", "input_zone" => "labels", "output_zone" => "ssf_wp_dyn_js", "label" => __("Submit Request", SSF_WP_TEXT_DOMAIN), "input_template" => "<input type='text' name='ssfAddStores' value=\"$ssf_wp_vars[ssfAddStores]\" size='14'>","stripslashes" => 1);
