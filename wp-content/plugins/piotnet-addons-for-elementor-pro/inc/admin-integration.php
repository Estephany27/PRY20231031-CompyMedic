        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-google-sheets-client-secret" value="<?php echo $client_secret; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
            <tr valign="top">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-google-calendar-client-secret" value="<?php echo $gg_cld_client_secret; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-google-calendar-client-api-key" value="<?php echo $client_api_key; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
            <tr valign="top">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-google-maps-api-key" value="<?php echo $google_maps_api_key; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
        </table>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-stripe-secret-key" value="<?php echo $secret_key; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
        </table>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row"><?php _e('Client Secret','pafe'); ?></th>
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-paypal-client-secret" value="<?php echo $client_secret; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
        </table>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td class="pafe-settings-page-td">
                    <input type="password" name="piotnet-addons-for-elementor-pro-mollie-api-key" value="<?php echo $mollie_api_key; ?>" class="regular-text"/>
                    <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                </td>
            </tr>
        </table>
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td><input type="text" name="piotnet-addons-for-elementor-pro-hubspot-access-token" value="<?php echo $hubspot_access_token; ?>" class="regular-text"/></td>
            </tr>
        </table>
		<?php submit_button(__('Save Settings','pafe')); ?>
    </form>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-mailchimp-api-key" value="<?php echo $api_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-mailerlite-api-key" value="<?php echo $api_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-sendinblue-api-key" value="<?php echo $sendinblue_api_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-activecampaign-api-key" value="<?php echo $api_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
                <tr valign="top">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-getresponse-api-key" value="<?php echo $getresponseapi_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Secret Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-recaptcha-secret-key" value="<?php echo $secret_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td class="pafe-settings-page-td">
                        <input type="text" name="piotnet-addons-for-elementor-pro-twilio-author-token" value="<?php echo $author_token; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-sendfox-access-token" value="<?php echo $sendfox_access_token; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-constant-contact-client-id" value="<?php echo $c_ID; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-constant-contact-app-secret-id" value="<?php echo $app_secret; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
                <tr valign="top">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('API Key','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-convertkit-api-key" value="<?php echo $convertkit_api_key; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
            </table>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><?php _e('Client Secret','pafe'); ?></th>
                    <td class="pafe-settings-page-td">
                        <input type="password" name="piotnet-addons-for-elementor-pro-zoho-client-secret" value="<?php echo $client_secret; ?>" class="regular-text"/>
                        <label class="pafe-settings-page-show-password-icon" data-settings-page-show-password-icon><i class="fa fa-eye"></i></label>
                    </td>
                </tr>
                <tr valign="top">
