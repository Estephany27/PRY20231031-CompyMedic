							...
							<?php if ($index == count($list)) : ?>
								...
								<?php if( !empty($settings['pafe_stripe_enable']) ) : ?>
									<div class="pafe-form-builder-alert pafe-form-builder-alert--stripe">
										<div class="elementor-message elementor-message-success" role="alert" data-pafe-form-builder-message><?php echo $settings['pafe_stripe_message_succeeded']; ?></div>
								...
								<?php if(!empty($settings['mollie_enable'])): ?>
									<div class="pafe-form-builder-alert pafe-form-builder-alert--mollie">
										<div class="elementor-message elementor-message-success" role="alert" data-pafe-form-builder-message><?php echo $settings['pafe_mollie_message_succeeded']; ?></div>
								...
								<?php if(!empty($settings['paypal_enable'])): ?>
									<div class="pafe-form-builder-alert pafe-form-builder-alert--paypal">
										<div class="elementor-message elementor-message-success" role="alert" data-pafe-form-builder-message><?php echo !empty($settings['pafe_paypal_message_succeeded']) ? $settings['pafe_paypal_message_succeeded'] : 'Payment Success'; ?></div>
								...
								<div class="pafe-form-builder-alert pafe-form-builder-alert--mail">
									<div class="elementor-message elementor-message-success" role="alert" data-pafe-form-builder-message><?php echo $settings['success_message']; ?></div>
